...
/***/ "./src/About-webpack/form-control.ts":
/*!*******************************************!*\
  !*** ./src/About-webpack/form-control.ts ***!
  \*******************************************/
...
function checkForEmptyFields(...inputs) {
    inputs.forEach((input) => {
        if (!input.value)
            showErrorMesage(input, 'Este campo não pode ficar vazio');
    });
}
...
function showErrorMesage(input, msg) {
...
/*!************************************!*\
  !*** ./src/About-webpack/index.ts ***!
  \************************************/

Object.defineProperty(exports, "__esModule", ({ value: true }));
__webpack_require__(/*! ./form-control */ "./src/About-webpack/form-control.ts");
